...
function insulatorRate(head) {
  ...
  if (compact === "DP,DEST.4.5M") return [6, 12];
  if (compact === "DP,DDEST.4.5M") return [12, 24];
  if (compact === "DP,DDE.BLST.4.5M") return [6, 24];
  if (compact === "SP,DDE.BLST.4.5M") return [3, 24];
